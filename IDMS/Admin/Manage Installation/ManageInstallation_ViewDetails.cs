...
{
    public partial class ManageInstallation_ViewDetails : Form
    {
        private int PackageID;
        public ManageInstallation_ViewDetails()
        {
            InitializeComponent();
        }
        ...
        {
            this.Hide();
            ManageInstallation_UpdateForm edit = new ManageInstallation_UpdateForm(PackageID);
            edit.Show();
        }
        ...
        private void ManageInstallation_ViewDetails_Load(object sender, EventArgs e)
        {
        ...
        {
            this.Hide();
            ManageInstallation_AddForm_2 addComponent = new ManageInstallation_AddForm_2(PackageID) ;
            addComponent.Show();
        }
    }
}
